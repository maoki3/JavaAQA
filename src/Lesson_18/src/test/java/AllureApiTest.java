...
public class AllureApiTest {
    ...
    public void saveResults() {
        Allure.addAttachment("Test Result", "text/plain", "Результаты теста");
    }


    @Test
    @Description("Тестирование GET-запроса")
    ...
    @Step("Логирование заголовков ответа")
    private void logResponseHeaders(Response response) {
        System.out.println("Response Headers: " + response.getHeaders());
        System.out.println("Response Status Code: " + response.getStatusCode());
    }

    @Step("Проверка аргументов ответа")
    private void validateResponseArgs(Response response) {
    ...
    @Test
    @Description("Тестирование POST-запроса с текстовым содержимым")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test
    @Description("Тестирование POST-запроса с данными")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test
    @Description("Тестирование PUT-запроса")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test
    @Description("Тестирование PATCH-запроса")
    ...
    @Test
    @Description("Тестирование DELETE-запроса")
    @Severity(SeverityLevel.NORMAL)
